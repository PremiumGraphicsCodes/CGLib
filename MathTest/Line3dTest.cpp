...
TYPED_TEST(Line3dTest, TestIsSamePlane)
{
	using T = TypeParam;
	Line3d<T> line1(Vector3d<T>(0, 0, 0), Vector3d<T>(1, 0, 0));
	Line3d<T> line2(Vector3d<T>(0, 1, 0), Vector3d<T>(0, 1, 1));
	EXPECT_FALSE( line1.isSamePlane(line2) );
}
