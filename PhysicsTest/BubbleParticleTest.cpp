...
{
	const BubbleParticle p1(Vector3d<float>(0,0,0), Vector3d<float>(0,0,0), Vector3d<float>(1,0,0));
	const BubbleParticle p2(Vector3d<float>(1,0,0), Vector3d<float>(-1,0,0), Vector3d<float>(1,0,0));
...
{
	const BubbleParticle p1(Vector3d<float>(0, 0, 0), Vector3d<float>(1, 0, 0), Vector3d<float>(1, 0, 0));
...
{
	const BubbleParticle p1(Vector3d<float>(0, 0, 0), Vector3d<float>(1, 0, 0), Vector3d<float>(1, 0, 0));
	EXPECT_EQ(0.5f, p1.getKineticEnegy(1.0f));
}