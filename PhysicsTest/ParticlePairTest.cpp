...
{
	const auto p1 = std::make_shared< Particle >( Vector3d<float>( 0, 0, 0 ));
	const auto p2 = std::make_shared< Particle >( Vector3d<float>( 1, 1, 1 ));
...
{
	const auto p1 = std::make_shared< Particle >(Vector3d<float>(1, 2, 3));
	const auto p2 = std::make_shared< Particle >(Vector3d<float>(0, 0, 0));
