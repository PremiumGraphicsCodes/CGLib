...
std::vector< Triangle<GeomType> > MarchingCube<GeomType,ValueType>::march(const Volume3d<GeomType, ValueType>& volume, const ValueType isolevel) const
{
...
template<typename GeomType, typename ValueType>
std::vector< Triangle<GeomType> > MarchingCube<GeomType, ValueType>::build(const VolumeCell3d<GeomType, ValueType>& cell, const ValueType isolevel) const
{
	std::vector<Triangle<GeomType>> triangles;
...
template<typename GeomType, typename ValueType>
std::vector<Triangle<GeomType>> MarchingCube<GeomType, ValueType>::build(const int cubeindex, const std::array<Vector3d<GeomType>, 12>& vertices) const
{
	std::vector<Triangle<GeomType>> triangles;
...
template<typename GeomType, typename ValueType>
int MarchingCube<GeomType, ValueType>::getCubeIndex(const std::array< ValueType, 8 >& val, const ValueType isolevel) const
{
	std::bitset<8> bit;
...
template<typename GeomType, typename ValueType>
std::array< Vector3d<GeomType>, 12 > MarchingCube<GeomType, ValueType>::getPositions(const int cubeindex, const VolumeCell3d<GeomType, ValueType>& cell, const ValueType isolevel) const
{
...
template class MarchingCube<float, double>;
template class MarchingCube<float, float>;