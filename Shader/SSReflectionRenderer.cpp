...
void SSReflectionRenderer::render(const ITexture& depthTexture, const ITexture& normalTexture, const ICamera<float>& renderedCamera, const CubeMapTexture& cubeMapTexture)
{
