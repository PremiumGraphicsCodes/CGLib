...
public:
	...
	Bone* createBone(Joint* j1, Joint* j2, const Math::Vector3d<float>& thickness);
	...
	ParticleObject* toParticleObject(const float density, const float divideLength) const;
